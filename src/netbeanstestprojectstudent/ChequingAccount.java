...
//create a chequing account that extends Account
public class ChequingAccount {
    
    //constructor for Chequing Account
public Account(double bal, String fName, String lName, String str, String city, String st, String pc) {
		balance = bal;
		cust = new Customer(fName, lName, str, city, st);
	}
